...
//		    	    String currentPath = "C:\\Users\\Kylek\\newGBT\\rightClickMe\\src\\rightClickMe\\";
		    	    String currentPath = "E:\\test\\rightClickMe\\src\\rightClickMe\\";
...
//	    			        	int title = Integer.parseInt(overWriteAFile);
...
//	    			        	if(fileName.equals("}")) {
//	    			        		String removeSomething = fileName.substring(0 , fileName.length() - 1);
//	    			        		
//	    			        		JOptionPane.showMessageDialog(null, removeSomething);
//	    			        	}
//	    			        	JOptionPane.showMessageDialog(null, "Test: " + findCurlyBracet(fileName));
...
//////	    			        		FileWriter append = new FileWriter(currentPath, true);
////	    			        		
////	    			        		
//////	    			        		FileWriter append = new FileWriter("E:\\test\\rightClickMe\\src\\rightClickMe\\", true);
////
//	    			        		String test = " @Test \n"
//											 
//												+ " public void " + "testing" + selectedText + ts + "() { \n"
//		
//		
...
////	    			        	
//////	    			        		append.close();
//	    			        		try (BufferedWriter append = new BufferedWriter(new FileWriter(currentPath, true))) {
////		    			        		writeContent(fileName, packageName, imports, currentPath);
////	    			        			append.write("Appending a test.");
//
//
//	    			        			
//       	    			        		int anotherTest = JOptionPane.showConfirmDialog(null, "Do you want another test?");
//       	    			        		
//       	    			        		if(anotherTest == JOptionPane.YES_OPTION) {
//           	    			        		append.write(test);
//    	    			        			System.out.println("Test appended successfully.");
//       	    			        		}
//       	    			        		else {
//       	    			        			append.write("}");
//       	    			        		}
...
//	    			        		}
//	    			        		catch (IOException e) {
//	    			                    System.err.println("Error appending test: " + e.getMessage());
//	    			        		}
//	    			        	
//	    			        	}         
	    			        }
//	    			        else {
//	    			            JOptionPane.showMessageDialog(null, "Selected text is not equal to the file name.");	    			    		
//	    			        }
	    			    }
	    			}
							...
							StringBuilder variableAssignments1 = new StringBuilder();
							 ...
							 for (int i = 0; i < splitArray.length; i++) {
								 ...
								 if(overWriteAFile == JOptionPane.NO_OPTION) {
									...
									currentPath = "E:\\test\\rightClickMe\\src\\rightClickMe\\";
...
//	    			        			
//	    			        			int lastCharInt = reader.read();
//	    			        			char lastChar = (char) lastCharInt;
//	    			        			
//	    			        			
//	    			        			if(lastChar == '}') {
//	    			                        System.out.println("The file ends with '}'.");
//	    			        			}
//	    			        			else {
//	    			                        System.out.println("The file does not end with '}'.");
//	    			        			}
//	    			        			
//	    			        			reader.close();
       	    			        		...
       	    			        		String ts = timeStamp();
    			        				FileWriter file = new FileWriter("E:\\test\\rightClickMe\\src\\rightClickMe\\" + fileName + ts + ".java");   	    			        		
...
//        													+ randomBoolValue + "\n"
    		    			        					...
    		    			        					for (int j = 0; j < newboolValue.length; j++) {
													        ...
													        file.write("	boolean booleanVariable" + (j + 1) + " = " + boolValue + ";\n");
		       	    			        				}	
...
//									 writeContent(currentPath, selectedText, variableAssignments1, ans);
//								 }
								 ///////////////
...
//							 if(response == JOptionPane.NO_OPTION && doYouWantBoundaryValuesBoolean == JOptionPane.NO_OPTION && overWriteAFile == JOptionPane.NO_OPTION) {
//								 myWriter.write("}");
//							 }
...
//			                	myWriter = new FileWriter("C:\\Users\\Kylek\\newGBT\\rightClickMe\\src\\rightClickMe\\" + fileName + ".java");
    ...
    public static void writeContent(String filePath, String selectedText, StringBuilder variableAssignments, String ans) throws IOException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath, true))) {
            writer.write("public void " + "testing" + selectedText + "() { \n");
            writer.newLine();
            writer.write(variableAssignments + "\n");
            writer.newLine();
            writer.write(ans + "\n");
            writer.newLine();
