        ...
        if (editor != null) {
            ...
            if (selection instanceof ITextSelection) {  
                ...
                try {
		    	    ...
		    	    cls = Class.forName("rightClickMe.test");
					...
					if (dynamicMethod != null) {
					    ...
					    if(returnType.equals(long.class)) {
					        ...
					        String longQuestion = JOptionPane.showInputDialog(null, "Method you picked: " + selectedText + "\n" + "What should be the expected result from these long values: " + longArrayAsString + "?", "Provide Expected Result",  JOptionPane.QUESTION_MESSAGE);
					    	long convertLong = Long.parseLong(longQuestion);
					    	
					    	
//					    	Class<?> dynamicClass = Class.forName(classSimpleName);
//					    	classSimpleName = cls.getName();
//					    	System.out.println(classSimpleName);

//					    	JOptionPane.showMessageDialog(null, "dynamicClass has: " + classSimpleName);
					    	
					    	StringBuilder methodCall = new StringBuilder(test.class.getName() + "." + selectedText + "(");
...
//							if(methodToTrack(selectedText) > 0) {
//								int counter = 0;
//								
...
//							final Map<String, Integer> methodSelectionCounts = new HashMap<>();

					    	
//							JOptionPane.showMessageDialog(null, "This is a test: " + methodToTrack(selectedText));
...
//
//					    	 int doYouWantToOverWiteThisFile = JOptionPane.showConfirmDialog(null, "Do you want to overwrite this file?", "OverWrite this file",
//		                             JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);		
					    
					    	 
					    	 
//					    	 final Map<String, Integer> methodCallCounts = new HashMap<>();
					    	
//					    	 
//					    	 if(doYouWantToOverWiteThisFile == JOptionPane.YES_OPTION) {
//					    		 JOptionPane.showMessageDialog(null, "Yes");
//					    		 
//					    		 
//					    		 if (isMethodSelectedMultipleTimes(selectedText, methodSelectionCounts)) {
//					    			    // The method has been selected more than once
//					    			    // Generate new data or perform required actions
//					    			 long[] longt = randomLong(method);
//					    			 JOptionPane.showMessageDialog(null, "This is a test: " + Arrays.toString(longt));
//					    			} 
								
//					    		 dynamic(selectedText);
//					    		 getMethodCallCount(selectedText, methodCallCounts);
					    		 
					    		 //int test = Integer.valueOf(selectedText);
					    		 
//					    		 selectedText = test;
					    		 
//					    		 if(test > 1) {
//					    			 System.out.println("dynamic method has been called again");
//					    		 }
					    		 
					    		 
//								 FileWriter newWriter = new FileWriter("c:\\test\\output.txt");
//								 newWriter.write("Hello Water");
//								 newWriter.close();
//								 
//							     File file = new File("c:\\test\\output.txt");
//								 
//								 if (file.exists() && !file.isDirectory()) {
//							            if (file.length() > 0) {
//							                System.out.println("The file has contents.");
//							            } else {
...
//			    	
//			        JCheckBox checkbox = new JCheckBox("Boundary Value");
//			        panel.add(checkbox);
					
							 
//			        int response = JOptionPane.showConfirmDialog(null, panel, "Boundary value", JOptionPane.YES_NO_OPTION);
...
//			                	myWriter = new FileWriter("C:\\Users\\Kylek\\newGBT\\rightClickMe\\src\\rightClickMe\\" + fileName + ".java");
		                     ...
		                     if (yORn == JOptionPane.YES_OPTION) {
		                    	 ...
		                    	 for(int i=1; i<= testsToMake; i++) {
	                					...
	                					StringBuilder methodCall2 = new StringBuilder(test.class.getName() + "." + selectedText + "(");
	...
	public static int boundaryValue(int negative, int positive) {
		Random rand = new Random();
		int positiveNumber = rand.nextInt(120);
		int zero = 0;
		
		int negativeValue = rand.nextInt(120);		
        int negativeNumber = -negativeValue;

        System.out.println("Random Positve value: " + positiveNumber);
		System.out.println("Random Negative value: " + negativeNumber);
