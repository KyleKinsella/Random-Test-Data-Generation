...
//	    	        testClass = Class.forName("rightClickMe.test");
	    	        
	            	dynamicMethod = dynamic(selectedText);
//	            	JOptionPane.showMessageDialog(null, "This is a test: " + dynamicMethod);
	            	
	    	      
	            	 // Load the classes
//	                Class<?> classSelectText = Class.forName("rightClickMe.selectText"); // Adjust package name as necessary
//	                Class<?> classTest = Class.forName("rightClickMe.test"); // Adjust package name as necessary
//
//	                // Specify the method name you are looking for
//	                String methodName = selectedText; // Change to the actual method name
//
//	                // Check if the method exists in selectText
//	                Method methodInSelectText = findMethodInClass(classSelectText, methodName);
//	                Method methodInTest = findMethodInClass(classTest, methodName);
//
//	                // Output results
//	                if (methodInSelectText != null) {
//	                	JOptionPane.showMessageDialog(null, "Method '" + methodName + "' found in selectText");
//	                }
//	                if (methodInTest != null) {
//	                	JOptionPane.showMessageDialog(null, "Method '" + methodName + "' found in test");
//	                }
//
//	                if (methodInSelectText == null && methodInTest != null) {
//	                	JOptionPane.showMessageDialog(null, "Method '" + methodName + "' is in test.java but not in selectText.java");
//	                }
...
//					    Method testmethod = testClass.getMethod(selectedText, parameterTypes);
...
//   	  
//        String directoryPath = "C:\\RandomTestDataGeneration\\rightClickMe\\src\\rightClickMe\\";
//
//        // Call the findTestClass method to find the test.java file
//        File testJavaFile = findTestClass(directoryPath);
//
//        if (testJavaFile != null) {
//            try {
//                // Read the contents of the test.java file
//                List<String> lines = Files.readAllLines(testJavaFile.toPath());
//                JOptionPane.showMessageDialog(null, "lines is: \n" + lines);
//
//                // Extract the class name from the file content
//                String className = extractClassName(lines);
//                JOptionPane.showMessageDialog(null, "classname is: " + className);
//
//                // Call the dynamic method to load the class dynamically
//                Method method = dynamic(className, selectedText); // Change "methodName" to the desired method name
////                JOptionPane.showMessageDialog(null, "method is: " + method);
//
//                if (method != null) {
//                	JOptionPane.showMessageDialog(null, "Method found: " + method);
//                } else {
...
//            }
//        } else {
//        	JOptionPane.showMessageDialog(null, "test.java not found in the directory: " + directoryPath);
//        }
//	}
	...
	public String arrayToString(int[] array) {
	 ...
	 public static char[] generateRandomChar(Method method) {
	  ...
	  public static Method findMethodInClass(Class<?> cls, String methodName) {
