...
//				            JOptionPane.showMessageDialog(null, "test: " + Arrays.toString(generateArrays));
			                ...
			                StringBuilder arrayString = new StringBuilder("int[] array" + " " + " = {");
				            if (generateArrays != null) {
					            for (int i = 0; i < generateArrays.length; i++) {
					                arrayString = new StringBuilder("int[] array" + i + " = {");
					            	...
					            	String arrayQuestion = JOptionPane.showInputDialog(null, "Return type is: " + "int[][] or int[]" + "\n" + "Method you picked: " + selectedText + "\n" + "Type in the following that is on the right hand side: \'" + arrayString.toString() + "\'" + "?", "Provide Expected Result",  JOptionPane.QUESTION_MESSAGE);
...
//			                	myWriter = new FileWriter("C:\\Users\\Kylek\\newGBT\\rightClickMe\\src\\rightClickMe\\" + fileName + ".java");
    ...
    public static boolean isBoolean(boolean yes, boolean no, boolean b, boolean isAwake) {
