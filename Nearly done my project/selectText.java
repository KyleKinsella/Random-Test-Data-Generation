...
//			    	String string = returnType.getSimpleName();
//			    	
//			    	String intArrays = "int[][]";



	            	String path = "E:\\ffsMAN\\rightClickMe\\src\\rightClickMe\\" + fileName + ".java";
...
//		    	    String currentPath = "C:\\Users\\Kylek\\newGBT\\rightClickMe\\src\\rightClickMe\\";
		    	    String currentPath = "E:\\ffsMan\\rightClickMe\\src\\rightClickMe\\";
...
//	    			            JOptionPane.showMessageDialog(null, "selectedText is equal to the fileName");
	    			        	...
	    			        	if(overWriteAFile == JOptionPane.YES_OPTION) {
	    			        		myWriter = new FileWriter("E:\\ffsMAN\\rightClickMe\\src\\rightClickMe\\" + fileName + ".java");
					...
					if (dynamicMethod != null) {
								 ...
								 for (int k = 0; k < generateArrays.length; k++) {
									 ...
									 if(overWriteAFile == JOptionPane.NO_OPTION) {
					        				...
					        				file.write("package " + packageName + ";" + "\n\n" +
		   	    			        		...
		   	    			        		while(anotherTest == JOptionPane.YES_OPTION) {
		       	    			        		...
		       	    			        		anotherTest = JOptionPane.showConfirmDialog(null, "Below are the options and what happens when you pick a certain button.\n" + "Yes: This will add a new test to a new Java file, just don't press the Yes button too quickly because each test has a timestamp.\n" + "No: When you are done adding all of your tests make sure to press the No button because this writes a curly bracket to close the class off, so you can run your tests.\n" + "Do you want another test?");
		   	    			        			if(anotherTest == JOptionPane.YES_OPTION) {
		   	            	    			        
		       	    			        			
		   	    			        			

		   	    			        				
		   	    							        String provide = JOptionPane.showInputDialog(null, "Return type is: " + "int[][]" + "\n" + "Method you picked: " + selectedText + "\n" + "Input a number for each column combined then followed by a comma, from the below arrays:" + "\n" + allArrays.toString(), "Provide Expected Result",  JOptionPane.QUESTION_MESSAGE);
			        				...
			        				file.write("package " + packageName + ";" + "\n\n" +
   	    			        		...
   	    			        		while(anotherTest == JOptionPane.YES_OPTION) {
   	    			        			...
   	    			        			if(anotherTest == JOptionPane.YES_OPTION) {
   	    							        ...
   	    							        String provide = JOptionPane.showInputDialog(null, "Return type is: " + returnType + "\n" + "Method you picked: " + selectedText + "\n" + "What should be the expected result from these long values: " + Arrays.toString(newLongValue) + "?", "Provide Expected Result",  JOptionPane.QUESTION_MESSAGE);
				        				...
				        				file.write("package " + packageName + ";" + "\n\n" +
	   	    			        		...
	   	    			        		while(anotherTest == JOptionPane.YES_OPTION) {
	   	    			        			...
	   	    			        			if(anotherTest == JOptionPane.YES_OPTION) {
	   	    			        				...
	   	    			        				String provide = JOptionPane.showInputDialog(null, "Return type is: " + returnType + "\n" + "Method you picked: " + selectedText + "\n" + "What should be the expected result from these double values: " + Arrays.toString(newDoubleValue) + "?", "Provide Expected Result",  JOptionPane.QUESTION_MESSAGE);
			        				...
			        				file.write("package " + packageName + ";" + "\n\n" +
   	    			        		...
   	    			        		while(anotherTest == JOptionPane.YES_OPTION) {
   	    			        			...
   	    			        			if(anotherTest == JOptionPane.YES_OPTION) {
   	    							        ...
   	    							        String provide = JOptionPane.showInputDialog(null, "Return type is: " + returnType + "\n" + "Method you picked: " + selectedText + "\n" + "What should be the expected result from these float values: " + Arrays.toString(newFloatValue) + "?", "Provide Expected Result",  JOptionPane.QUESTION_MESSAGE);
    			        				...
    			        				file.write("package " + packageName + ";" + "\n\n" +
       	    			        		...
       	    			        		while(anotherTest == JOptionPane.YES_OPTION) {
       	    			        			...
       	    			        			if(anotherTest == JOptionPane.YES_OPTION) {
       	    			        				...
       	    			        				String provide = JOptionPane.showInputDialog(null, "Return type is: " + returnType + "\n" + "Method you picked: " + selectedText + "\n" + "What should be the expected result from these boolean values: " + boolValueString  + "?", "Provide Expected Result",  JOptionPane.QUESTION_MESSAGE);
			         ...
			         JOptionPane.showMessageDialog(null, "Your Java file has been created");	
		            	...
		            	if(returnType.equals(int.class) || returnType.equals(float.class) || returnType.equals(double.class) || returnType.equals(long.class) || returnType.equals(boolean.class) || returnType.equals(String.class) || returnType.equals(char.class) || returnType.equals(int[][].class) || returnType.isArray() && returnType.getComponentType() == int.class) {
			            	
			            	
		            		
		            	String yourTests = "YourTests"; // parent
		            	String child = returnType + "tests"; // child
		            	
		            	
		            	String pack = packageName + "." + "YourTests" + "." + child;
		            	JOptionPane.showMessageDialog(null, "Pack: " + pack);
		            	
		            	
		                String parentFolderPath = "E:\\ffsMAN\\rightClickMe\\src\\" + yourTests;
		                String childFolderPath = parentFolderPath + "\\" + child;
		                
		                File parentFolder = new File(parentFolderPath);

		                
		                // Create the parent folder
		                boolean createdParentFolder = parentFolder.mkdirs();
		                ...
		                // Create a File object for the child folder path
		                File childFolder = new File(childFolderPath);

		                // Create the child folder within the parent folder
		                boolean createdChildFolder = childFolder.mkdir();
		                if (createdChildFolder) {
		                    System.out.println("Child folder created successfully within the parent folder.");
		                } else {
		                    System.out.println("Failed to create child folder within the parent folder.");
		                }
		            	
		            	
		                
		            	
//		            	String dirPath = "E:\\ffsMAN\\rightClickMe\\src\\" + yourTests;
...
//						if(createdDir) {
//				            System.out.println("Your Folder has been created successfully.");
//						}
//						else {
...
//						}
	                ...
	                File newFilePath = new File(parentFolderPath + "\\" + child + "\\" + fileName + ".java");
	                boolean moved = filePath.renameTo(newFilePath);
	                if (moved) {
//	                	
	                	myWriter.write("package " + pack);
	                	
//	                	pack = "YourTests" + "." + child;
//		            	parentFolderPath = parentFolderPath + pack;
//		            	
	                    System.out.println("File moved successfully to the folder.");
	                } else {
	                    System.out.println("Failed to move file to the folder.");
	                }
    ...
    public static String checkIfDirExists(String currentPath) {
    	String directoryPath = currentPath;
        String flagFileName = "directory_created.flag";
//        boolean showMessage = true; // Flag to indicate whether to show the message
        ...
        if (!Files.exists(path)) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Directory was created successfully.");
                
                File flagFile = new File(flagFileName);
                flagFile.createNewFile();
            } catch (IOException e) {
            	JOptionPane.showMessageDialog(null, "Failed to create directory: " + e.getMessage());
            }
        } else {
